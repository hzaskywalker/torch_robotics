...
class Trainer:
    ...
    def add_video(self, to_vis):
        to_vis['reward_eval'] = eval_policy(self.controller, self.env, eval_episodes=5,
...
def main():
    ...
    parser.add_argument("--env_name", type=str, default='arm', choices=['arm', 'acrobat2'])

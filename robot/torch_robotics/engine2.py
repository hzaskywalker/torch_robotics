...
from .geometry.simplex2 import SimpleCollisionDetector
from robot.torch_robotics.contact.elastic2 import StewartAndTrinkle
...
class Engine2(Builder):
    ...
    def __init__(self, contact_dof=1, contact_model=None,
        ...
        super(Engine2, self).__init__(collision_threshold)

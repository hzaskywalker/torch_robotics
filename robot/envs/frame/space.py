...
class Space(GymSpace):
    ...
    @property
    def size(self):
        # return the size of variable in this space
    ...
    @property
    def shape(self):
        # return the shape of variable in this space
        return self._shape
    ...
    def derivative_space(self):
        # the deriviative space will be the same as observation_space by default
        return self.observation_space

    @property
    def observation_space(self):
        # the observation space will be the same to self by default
        return self
